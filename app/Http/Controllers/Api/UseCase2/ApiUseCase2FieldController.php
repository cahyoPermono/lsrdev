...
use App\Services\MedcoApi\UseCase2FieldService;
use Illuminate\Http\Request;
use Laililmahfud\Adminportal\Controllers\ApiController;

/**
 * @group Use Case 2/Field [4]
 * @sorting 13
 */
class ApiUseCase2FieldController extends ApiController
{
    ...
    {
        $items = $this->useCase2FieldService->summary($code);
    ...
    {
        $items = $this->useCase2FieldService->productionData($code);
        return $this->sendSuccess($items);
    }
